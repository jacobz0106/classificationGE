...
def Accuracy_comparison_CV(n , nTest, repeat = 20):
	...
	f = open("running_task_check/task_elliptic_CV.txt", "a")
...
def main():
	...
	np.savetxt('Results/CVresults/Train_accuracy_elliptic_100.csv', accuracyTrain, delimiter=",", header = '' )
	np.savetxt("Results/CVresults/Prediction_accuracy_elliptic_100", accuracyPrediction, delimiter=",", header = '' )
