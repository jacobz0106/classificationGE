...
def Accuracy_comparison_CV(n , nTest, repeat = 20):
	...
	f = open("running_task_check/task_f1_CV.txt", "a")
	for i in range(repeat):
		...
		dfTrain = dataSIP.df[['X1','X2']].values
		...
		X_test = dataSIP.df[['X1','X2']].values
...
def main():
	...
	np.savetxt('Results/CVresults/Train_accuracy_f1_100.csv', accuracyTrain, delimiter=",", header = '' )
	np.savetxt("Results/CVresults/Prediction_accuracy_f1_100", accuracyPrediction, delimiter=",", header = '' )
