...
def main():
	...
	np.savetxt('Results/CVresults/Train_accuracy_f2_100.csv', accuracyTrain, delimiter=",", header = '' )
	np.savetxt("Results/CVresults/Prediction_accuracy_f2_100", accuracyPrediction, delimiter=",", header = '' )
